...
function ServiceCard({ title, desc, icon, image }: ServiceCardProps) {
    ...
    <section id="services" className="w-full bg-black section-padding overflow-hidden relative">
      ...
      <div className="container-width grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center relative z-10">
        ...
        >
          ...
          <Link to="/services" className="text-gold text-xs tracking-[0.25em] uppercase font-semibold hover:text-gold-light transition-colors inline-flex items-center gap-2">
