    ...
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          >
            {/* Modal Card wrapper with a subtle border, dark transparent overlay, and NO blur */}
            <div className="w-full shadow-2xl border border-white/10 rounded-sm bg-black/45 relative p-6 md:p-8 flex flex-col">
              {/* Close Button */}
              <button
                onClick={onClose}
