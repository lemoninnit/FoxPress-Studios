...
export default function Navbar({ onContactClick }: NavbarProps) {
  ...
  return (
    <m.header
      ...
      className={`fixed top-0 left-0 right-0 z-50 w-full transition-all duration-300 block ${isScrolled ? 'bg-transparent backdrop-blur-[2px] border-b border-white/5 shadow-none' : 'bg-transparent'}`}
    >
